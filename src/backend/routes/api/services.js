        ...
        validator({
            ...
            .then((data) => {
                return Promise.all([
                    ...
                    internalService.getAll(res.locals.access, req.query.offset, req.query.limit, data.sort, data.expand, data.query)
                ]);
            })
            .then((data) => {
...
router
     ...
     */
    .get((req, res, next) => {
        internalService.getAvailable(res.locals.access)
            .then((services) => {
                res.status(200)
                    .send(services);
            })
...
router
     ...
     */
    .post((req, res, next) => {
        res.locals.access.can('services')
            .then(() => {
...
router
     ...
     */
    .delete((req, res, next) => {
        internalService.delete(res.locals.access, {id: req.params.service_id})
            .then((result) => {
                res.status(200)
                    .send(result);
            })
