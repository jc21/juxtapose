...
const templates = [
	 ...
	 */
	{
		service_type:    common_values.service_type_ntfy,
		...
		content:         '{\n' +
							 ...
							 '  }]\n' +
							 '}',
		default_options: common_values.ntfy_defaults,
